...
urlpatterns = [
    ...
    re_path(r'^onboarding_part1', onboarding1, name="onboarding1"),
    re_path(r'^onboarding_part2', onboarding2, name="onboarding2"),
    re_path(r'^add/', add_product, name="add_product"),
    re_path(r'^(?P<slug>.*)/edit/', edit_product, name="edit_product"),
    re_path(r'^add-wish/', add_wish, name="add_wish"),
    re_path(r'^(?P<slug>.*)/edit-wish/', edit_wish, name="edit_wish"),
