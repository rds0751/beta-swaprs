...
def activate(request, activation_key,
    ...
    return render(request, 'registration/registration_form.html', context_instance={'next':next} )
...
def register(request, success_url=None,
    ...
    return render(request,template_name=template_name,context={'rForm':rform,'lForm':lform,'next':next})
